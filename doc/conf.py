...
latex_documents = [
  ('index', 'Flask-RESTX.tex', u'Flask-RESTX Documentation',
...
man_pages = [
    ('index', 'flask-restx', u'Flask-RESTX Documentation',
     [u'Axel Haustant'], 1)
]
...
texinfo_documents = [
  ('index', 'Flask-RESTX', u'Flask-RESTX Documentation',
   u'Axel Haustant', 'Flask-RESTX', 'One line description of project.',
   'Miscellaneous'),
]
