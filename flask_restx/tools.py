...
def _get_res(table, modelname: str = None, readonlyfields: list = [], show: list = []) -> Model:
...
def createApiModel(api, table, modelname: str = None, readonlyfields: list = [], show: list = []) -> Model:
